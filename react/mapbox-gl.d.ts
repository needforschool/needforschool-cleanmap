...
declare namespace mapboxgl {
  ...
  class LngLatBounds {
    ...
    static convert(
      input: LngLatBounds | Array<number> | Array<Array<number>>
    ): LngLatBounds;
  }
  ...
  class Map extends Evented {
    ...
    queryRenderedFeatures(
      pointOrBox?: Point | Array<number> | Array<Point> | Array<Array<number>>,
      params?: { layers?: Array<string>; filter?: Array<any> }
    ): Array<GeoJSON.Feature>;

    querySourceFeatures(
      sourceID: string,
      params?: { sourceLayer?: string; filter?: Array<any> }
    ): Array<GeoJSON.Feature>;
    ...
    fitBounds(
      bounds: LngLatBounds | Array<Array<number>>,
      options: {
        linear?: boolean;
        easing?: Function;
        padding?: number;
